                            ...
                            <form method="POST" action="{{ route('admin.siswa.update', $siswa->nis) }}" class="needs-validation">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nis') is-invalid @enderror" 
                                           id="nis" name="nis" placeholder="Contoh: 12001" value="{{ old('nis', $siswa->nis) }}" required>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('keterangan') is-invalid @enderror" 
                                           id="keterangan" name="keterangan" placeholder="Contoh: Aktif" maxlength="10" value="{{ old('keterangan', $siswa->keterangan) }}" required>
