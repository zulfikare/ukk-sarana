                    ...
                    <div class="card shadow mb-4">
                        <div class="card-header py-3">
                            <h6 class="m-0 font-weight-bold text-primary">
                                <i class="fas fa-user-plus"></i> Form Input Siswa Baru
                            </h6>
                        </div>
                        <div class="card-body">
                            <form method="POST" action="{{ route('admin.siswa.store') }}" class="needs-validation">
                                @csrf
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('nama') is-invalid @enderror" 
                                           id="nama" name="nama" placeholder="Contoh: Budi Santoso" value="{{ old('nama') }}">
                                    @error('nama')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" class="form-control @error('kelas') is-invalid @enderror" 
                                           id="kelas" name="kelas" placeholder="Contoh: X A, XI B, XII C" maxlength="20" value="{{ old('kelas') }}" required>
                                    @error('kelas')
                                        <div class="invalid-feedback d-block">{{ $message }}</div>
                                    @enderror
                                </div>
